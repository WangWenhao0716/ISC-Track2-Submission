...
if __name__ == "__main__":
    ...
    if args.read_norms:
        ...
        if args.reduction == "min":
            norms = -train_scores[:, -1] 
        elif args.reduction == "avg":
            norms = -train_scores.mean(axis=1) 
        else:
            assert False
    ...
    xq_1 = xq * norms[:, None] * args.factor
    
    write_hdf5_descriptors(xq_1,query_image_ids, 'features/query_byol_detection_multi_scale_ds.hdf5')
    '''
